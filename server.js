  ...
  try {
    ...
    for (let d = new Date(startDate); d <= new Date(); d.setDate(d.getDate() + 1)) {
      ...
      result.push({
        ...
        shift1: { ...shift1Outcome, check_in: s1CheckIn ? s1CheckIn.event_time : null, check_out: s1CheckOut ? s1CheckOut.event_time : null, shift_end: shift1End },
        shift2: { ...shift2Outcome, check_in: s2CheckIn ? s2CheckIn.event_time : null, check_out: s2CheckOut ? s2CheckOut.event_time : null, shift_end: shift2End }
      });
    }

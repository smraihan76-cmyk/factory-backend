...
"""`;
  ...
  const res = await fetch(
    `https://generativelanguage.googleapis.com/v1beta/models/gemini-3.6-flash:generateContent?key=${cred.api_key}`,
    {
      method: 'POST',
  ...
  // Gemini এরর দিলে (যেমন ভুল/বাতিল হওয়া মডেল, কোটা শেষ, ভুল API key) আসল কারণটা দেখানো হচ্ছে,
  // যাতে "AI থেকে উত্তর পাওয়া যায়নি" এর মতো অস্পষ্ট মেসেজে আটকে না থাকতে হয়
  if (data.error) {
    throw new Error(data.error.message || 'Gemini API এরর দিয়েছে');
  }

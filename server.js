  ...
  for (let d = new Date(startDate); d <= new Date(); d.setDate(d.getDate() + 1)) {
    ...
    if (dayOfWeek === 5) {
      ...
      if (isOfflineOnThisDay) {
        breakdown.push({ date: dateStr, status: 'offline', late_minutes: 0, day_earned: 0 });
        continue;
      }
      breakdown.push({ date: dateStr, status: 'holiday', late_minutes: 0, day_earned: +dayDailyRate.toFixed(2) });
